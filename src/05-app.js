...
"erro-previsao":{ n:"Erro de previsão", c:"var(--amber)",
 ...
 onde:[
  ...
  {m:"decisao", l:1, p:"O orbitofrontal é quem CONSOME o sinal: quando o resultado desmente a previsão, é ele que reescreve o valor guardado."},
 ],
...
inibicao:{ n:"Inibição", c:"var(--rose)",
 ...
 onde:[
  ...
  {m:"autonomo", l:2, p:"Aqui o freio não vem de interneurônios: vem de um RAMO inteiro, com acetilcolina no alvo. Mesmo trabalho, outra arquitetura."},
 ],
 fecho:"Selecionar um movimento, focar num objetivo, formar um circuito, encerrar o estresse: em todos, o trabalho pesado é feito calando, não somando. E há dois papéis a mais que só aparecem fora do córtex — quando a inibição tem DURAÇÃO ela vira relógio, nos ritmos; e quando ela precisa alcançar o corpo inteiro, ela deixa de ser interneurônio e vira um ramo inteiro do autônomo."},
...
habito:{ n:"Gânglios da base e o hábito", c:"var(--green)",
 ...
 onde:[
  ...
  {m:"neuroanatomia", l:2, p:"Os gânglios da base entram como estrutura, antes de virarem mecanismo: ajustam movimento E hábito, o que já entrega a tese."},
 ],
...
"pre-frontal":{ n:"Córtex pré-frontal", c:"var(--blue)",
 ...
 onde:[
  ...
  {m:"decisao", l:2, p:"O desconto da espera e do esforço é decidido aqui — e é por isso que cansaço muda O QUE você escolhe, não só o quanto rende."},
...
hipocampo:{ n:"Hipocampo", c:"var(--orange)",
 ...
 onde:[
  ...
  {m:"neuroanatomia", l:2, p:"Aqui ele aparece pela primeira vez, como endereço: sob o córtex, dentro do sistema límbico, ao lado da amígdala."},
 ],
...
plasticidade:{ n:"Use ou perca", c:"var(--lime)",
 ...
 fecho:"Aprender, dormir, crescer, cegar, tratar depressão, aprender a ler: é tudo o mesmo motor. E repare que ele tem dois modos — fortalecer o que se usa, e REAPROVEITAR território para uma função que a evolução não previu. O cérebro está sempre esculpindo; a única questão é o que a experiência está esculpindo agora."},
