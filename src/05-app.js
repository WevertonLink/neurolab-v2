...
const MINI_QUIZZES = {
  ritmos:[
    ...
    [
      ...
      {lvl:1,q:"A proposta de que a razão theta/gama fixaria o limite da memória de trabalho deve ser tratada como:",o:["Disputada, com experimento dos dois lados","Só elegante: não há manipulação que a apoie","Estabelecida, tanto quanto o próprio acoplamento"], c:0,er:"Alongar o ciclo theta por estimulação aumenta a capacidade, o que é manipulação a favor. E o acoplamento medido tem artefato conhecido, o que é problema do outro lado. A disputa é entre evidências, não entre evidência e elegância.",ew:"Ela tem sim manipulação a favor — foi isso que eu quase deixei de fora. E não está estabelecida: o acoplamento nem sempre aparece, e em CA1 de macaco não foi encontrado."},
      {lvl:2,q:"Por que vale desconfiar ao transportar o acoplamento theta-gama do rato para o primata?",o:["Porque em CA1 de macaco ele não foi encontrado","Porque primatas não têm hipocampo comparável","Porque em primatas o gama não existe"], c:0,er:"O theta de primata também é mais lento e mais intermitente, o que já muda a conta. Mas o achado que mais pesa é mais duro que isso: em CA1 de macaco o acoplamento simplesmente não apareceu.",ew:"O hipocampo de primata é bem comparável, e o gama existe nos dois. O problema não é faltar estrutura — é o acoplamento não se repetir onde deveria."}
    ],
    [
