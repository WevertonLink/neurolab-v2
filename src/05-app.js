...
MODULES.push({
  ...
  intro:'A tomada de decisão exige traduzir recompensas totalmente diferentes (tempo, dinheiro, esforço, sabor) em uma mesma "moeda biológica" de valor subjetivo. Neste módulo, vamos aprofundar como o cérebro faz essa conversão e como arbitra conflitos temporais.',
  lessons:[
    {t:'O Córtex Pré-Frontal Ventromedial (vmPFC) e o Valor',
     b:`<p>A neuroeconomia biológica acontece primariamente no <span class="term">vmPFC</span>. Esta região, em forte diálogo com o núcleo accumbens e a amígdala, atua integrando o estado interno do organismo com a recompensa esperada, computando o <strong>valor imediato</strong> da escolha.</p><p>Quando há disfunção no vmPFC, o paciente perde a capacidade de alinhar a escolha racional com o sentimento de risco ou valor, um quadro clássico na dependência química e impulsividade.</p>`},
    {t:'Desconto Temporal e o dlPFC',
     b:`<p>Quando você precisa decidir entre ganhar R$ 50 hoje ou R$ 100 daqui a seis meses, o cérebro desvaloriza a recompensa futura — fenômeno chamado de <span class="term">desconto temporal hiperbólico</span>.</p><p>Para resistir à atração imediata do estriado ventral, o <span class="term">dlPFC (Córtex Pré-Frontal Dorsolateral)</span> precisa aplicar controle top-down, sustentando ativamente a meta abstrata futura no circuito. Indivíduos mais impulsivos apresentam menor ativação moduladora do dlPFC durante tarefas de decisão com atraso.</p>`}
  ],
  quiz:[
    {q:'Em tarefas de desconto temporal, pacientes com lesão severa no Córtex Pré-Frontal Dorsolateral (dlPFC) tenderão a:',
     ...
     er:'Correto! O <strong>dlPFC atua como freio inibitório</strong>. Sem sua atividade, o sinal de recompensa imediata do estriado ventral domina o comportamento.',
...
MODULES.push({
  ...
  intro:'Como medicamentos conseguem ajustar a ansiedade ou evitar convulsões sem desligar o cérebro por completo? Este módulo explora a engenharia por trás da manipulação das fendas sinápticas através de receptores.',
  lessons:[
    {t:'Receptores GABA-A e o Poro de Cloreto',
     b:`<p>O receptor GABA-A atua como um canal iônico rápido. Quando duas moléculas de GABA se ligam aos <span class="term">sítios ortostéricos</span> (principais), o poro se abre e permite o influxo de íons Cloreto (Cl-), hiperpolarizando o neurônio e reduzindo suas chances de disparo.</p>`},
    {t:'Moduladores Alostéricos Positivos (PAMs)',
     b:`<p>Medicamentos como os <strong>benzodiazepínicos</strong> não abrem o canal sozinhos. Eles se ligam a um <span class="term">sítio alostérico</span> lateral e alteram a estrutura do receptor. O resultado? Quando o GABA natural se liga, o canal passa a abrir com muito mais frequência.</p><p>Isso confere enorme segurança biológica: o medicamento apenas <strong>potencializa</strong> o sinal inibitório onde o neurotransmissor já existe e está agindo, em vez de desligar aleatoriamente o cérebro inteiro.</p>`}
  ],
  quiz:[
    {q:'Qual a principal diferença de mecanismo entre um Modulador Alostérico Positivo (como o Diazepam) e um agonista direto de GABA?',
     o:['O PAM depende da presença e ligação do neurotransmissor natural (GABA) para ter seu efeito de amplificação.','O PAM fecha permanentemente os canais de sódio sensíveis à voltagem.','O agonista direto converte inibição em despolarização de potássio.','O PAM não se liga a receptores na fenda sináptica.'], c:0, l:1,
     ...
     ew:'A diferença central é que o PAM <strong>depende do GABA natural</strong>. Sem GABA na fenda, o PAM não consegue abrir o canal inibitório.'}
  ]
});
