...
const MINI_QUIZZES = {
  ...
  recompensa:[
    ...
    [
      {lvl:0,q:"Uma meta granular é aquela que:",o:["É quebrada em avanços pequenos e mensuráveis","Tem prazo curto, mesmo sendo grande","Depende de recompensa externa para valer"], c:0,er:"Granular é sobre o TAMANHO do passo, não sobre o prazo. Cada avanço mensurável rende um pequeno sinal de recompensa; meta vaga e distante não produz sinal nenhum.",ew:"Prazo curto não torna uma meta granular — dá para ter meta grande e urgente, e ela segue sem passos visíveis. E recompensa externa é outro assunto: o sinal aqui vem do próprio avanço percebido."},
...
MINI_QUIZZES['motor']=[
  ...
  [
    {lvl:0,q:"O homúnculo motor é:",o:["O mapa do corpo no córtex motor, distorcido pelo controle que cada parte exige","O conjunto de músculos que um único neurônio comanda","A área que planeja o gesto antes de ele acontecer"], c:0,er:"É um mapa, e ele é distorcido de propósito: mão, língua e rosto ocupam áreas enormes porque exigem controle finíssimo — não porque sejam grandes.",ew:"O conjunto de músculos de um neurônio é a unidade motora, outra coisa. E planejar o gesto antes é a área pré-motora, adiante do córtex motor primário."},
...
MINI_QUIZZES['linguagem']=[
  [
    {lvl:0,q:"As regiões de Broca e de Wernicke são, hoje:",o:["Referências históricas dentro de redes distribuídas","Os dois únicos lugares onde a linguagem é processada","Áreas que só existem no hemisfério direito"], c:0,er:"Os nomes vieram de lesões que alteravam produção ou compreensão, e seguem úteis como referência. O que mudou é a moldura: a linguagem é rede, não dois pontos.",ew:"Nunca foram os únicos lugares, e a evidência atual afasta ainda mais essa leitura. E a predominância, em grande parte das pessoas, é do hemisfério ESQUERDO."},
...
MINI_QUIZZES['farmacologia']=[
  ...
  [
    {lvl:0,q:"Um depressor do sistema nervoso central é a droga que:",o:["Reforça o GABA, o principal freio do cérebro","Bloqueia a adenosina, que normalmente dá sono","Deprime o humor de quem a usa"], c:0,er:"Depressor é sobre o RITMO do cérebro, não sobre humor: álcool e benzodiazepínicos reforçam o freio, e por isso acalmam e sedam.",ew:"Bloquear adenosina é o que a cafeína faz, e ela é estimulante. E o nome não fala de humor — fala de acelerar ou frear o sistema."},
