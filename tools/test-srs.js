...
/* ---------- 19. Localização: âncoras reais e cobertura ---------- */
{
  ...
  eq(totalAncoras, 193, '19. o número de âncoras utilizáveis mudou — era 193 (185 + 8 do extra 01)');
  ...
  eq(ev(`MODULES.reduce((s,m)=>s+m.lessons.reduce((t,_,li)=>t+measurableDimensions(m.id,li).length,0),0)`), 291,
     '19. o total de caixas deveria ser 291 (275 + 16 do extra 01)');
