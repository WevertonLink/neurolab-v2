...
/* ---------- 19. Localização: âncoras reais e cobertura ---------- */
{
  ...
  eq(totalAncoras, 228, '19. o número de âncoras utilizáveis (207 + 17 do bloco B + 1 por aula da Fatia 2 que ancora um termo numa parte do diagrama do módulo). Atualize ao acrescentar aula com âncora de Localização');
  ...
  const ABSTRATOS = ['emocao-3','linguagem-2','linguagem-3','clinica-0','clinica-3','metodos-0','metodos-2','decisao-4','sono-4','neuroanatomia-4','sensorial-4'];
  ...
  eq(ev(`MODULES.reduce((s,m)=>s+m.lessons.reduce((t,_,li)=>t+measurableDimensions(m.id,li).length,0),0)`), 380,
