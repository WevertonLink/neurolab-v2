...
/* ---------- 19. Localização: âncoras reais e cobertura ---------- */
{
  ...
  const ABSTRATOS = ['emocao-3','linguagem-2','linguagem-3','clinica-0','clinica-3','metodos-0','metodos-2','decisao-4','sono-4','neuroanatomia-4'];
  ...
  eq(ev(`MODULES.reduce((s,m)=>s+m.lessons.reduce((t,_,li)=>t+measurableDimensions(m.id,li).length,0),0)`), 377,
